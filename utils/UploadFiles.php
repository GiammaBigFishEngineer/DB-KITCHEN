<?php
/*
Funzione per caricare i file su una cartella dando il percorso del file e l'id della cartella
*/
/*
...
class UploadFiles {
    ...
    public static function upload($id, $percorso) {
        $target_dir = $percorso . $id . "/";
        $uploadOk = 1;
